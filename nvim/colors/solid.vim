...
"highlight Normal          guifg=#c6c6c6    guibg=BLACK    gui=none
highlight Normal          guifg=#c6c6c6    guibg=#0B0B0B    gui=none
highlight SpecialKey      guifg=#7eaefd    guibg=NONE       gui=none
highlight NonText         guifg=#7eaefd    guibg=#0E0E0E    gui=none
...
if g:kolor_bold==0
  ...
  if g:kolor_alternative_matchparen==0
    highlight MatchParen      guifg=#ff5fd7     guibg=#2e2c29    gui=bold
  else
...
if &t_Co > 255
  ...
  if g:kolor_bold==0
    ...
    if g:kolor_alternative_matchparen==0
      highlight MatchParen      ctermfg=206     ctermbg=235    cterm=bold
    else
