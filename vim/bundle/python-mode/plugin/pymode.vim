...
call pymode#default('g:pymode_rope_autoimport_bind', '<Leader>zra')
...
call pymode#default('g:pymode_rope_goto_definition_bind', '<Leader>zg')
...
call pymode#default('g:pymode_rope_show_doc_bind', '<Leader>zd')

" Bind keys for find occurencies (leave empty for disable)
call pymode#default('g:pymode_rope_find_it_bind', '<Leader>zf')

" Bind keys for organize imports (leave empty for disable)
call pymode#default('g:pymode_rope_organize_imports_bind', '<Leader>zro')

" Bind keys for rename variable/method/class in the project (leave empty for disable)
call pymode#default('g:pymode_rope_rename_bind', '<Leader>zrr')

" Bind keys for rename module
call pymode#default('g:pymode_rope_rename_module_bind', '<Leader>zr1r')

" Bind keys for convert module to package
call pymode#default('g:pymode_rope_module_to_package_bind', '<Leader>zr1p')

" Creates a new function or method (depending on the context) from the selected lines
call pymode#default('g:pymode_rope_extract_method_bind', '<Leader>zrm')

" Creates a variable from the selected lines
call pymode#default('g:pymode_rope_extract_variable_bind', '<Leader>zrl')

" Inline refactoring
call pymode#default('g:pymode_rope_inline_bind', '<Leader>zri')

" Move refactoring
call pymode#default('g:pymode_rope_move_bind', '<Leader>zrv')

" Generate function
call pymode#default('g:pymode_rope_generate_function_bind', '<Leader>zrnf')

" Generate class
call pymode#default('g:pymode_rope_generate_class_bind', '<Leader>zrnc')

" Generate package
call pymode#default('g:pymode_rope_generate_package_bind', '<Leader>zrnp')

" Change signature
call pymode#default('g:pymode_rope_change_signature_bind', '<Leader>zrs')

" Tries to find the places in which a function can be used and changes the
" code to call it instead
call pymode#default('g:pymode_rope_use_function_bind', '<Leader>zru')
